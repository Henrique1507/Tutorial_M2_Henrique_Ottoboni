...
CREATE TABLE IF NOT EXISTS "Experiencia" (
	...
	"DataDeInicio"	TEXT,
	"DataDeTermino"	TEXT,
	PRIMARY KEY("NUM_Experiencia"), AUTOINCREMENT
...
CREATE TABLE IF NOT EXISTS "Realizacoes" (
	...
	"DataDeInicio"	TEXT,
	"DataDeTermino"	TEXT,
	PRIMARY KEY("NUM_Realizacoes"), AUTOINCREMENT
...
CREATE TABLE IF NOT EXISTS "SobreMim" (
	...
	"Email"	TEXT,
	"Endereco"	TEXT,
	PRIMARY KEY("NUM_SobreMim"), AUTOINCREMENT
...
CREATE TABLE IF NOT EXISTS "Habilidades" (
	...
	"HTML"	TEXT,
	"NUM_SobreMim"	NUMERIC,
	PRIMARY KEY("NUM_Habilidades"), AUTOINCREMENT
...
CREATE TABLE IF NOT EXISTS "Personalidade" (
	...
	"LorenIpsum"	TEXT,
	"NUM_SobreMim"	NUMERIC,
	PRIMARY KEY("NUM_Personalidade"), AUTOINCREMENT
	FOREIGN KEY("NUM_SobreMim") REFERENCES "SobreMim"("NUM_SobreMim")
);
